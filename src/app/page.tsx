  ...
  return (
    <div className="space-y-8 sm:space-y-12">
      ...
      <section className="relative bg-gradient-to-br from-pink-500 via-rose-400 to-pink-600 text-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl">
        ...
        <div className="absolute top-2 right-2 sm:top-4 sm:right-4 text-4xl sm:text-6xl opacity-20">🌸</div>
        <div className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4 text-2xl sm:text-4xl opacity-15">🌸</div>
        <div className="absolute top-1/2 left-1/4 text-xl sm:text-2xl opacity-10 hidden sm:block">🌸</div>
        ...
        <div className="relative z-10 px-4 sm:px-8 py-12 sm:py-16 md:py-20 lg:py-28 max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 md:mb-8 leading-tight">
            ...
            <span className="block text-pink-100 mt-1 sm:mt-2">with SakuYado</span>
          </h1>
      ...
      <section className="bg-gradient-to-br from-pink-50 to-white p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border-2 border-pink-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-pink-800 mb-2">Add Hotels</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-rose-800 mb-2">Auto Calculate</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-pink-800 mb-2">Compare & Choose</h3>
            <p className="text-sm sm:text-base text-pink-600">
      ...
      <div className="text-center space-x-3 sm:space-x-6 opacity-60">
        ...
        <span className="text-3xl sm:text-4xl animate-pulse delay-1000">🌸</span>
        <span className="text-2xl sm:text-3xl animate-pulse delay-2000">🌸</span>
      </div>
    </div>
  );
}
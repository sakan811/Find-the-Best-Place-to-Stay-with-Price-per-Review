...
class GetHotelDataFromDbTests(APITestCase):
    def setUp(self):
        ...
        RoomPrice.objects.create(
            hotel="Hotel A", room_price=100.0, review_score=4.5, price_per_review=22.22,
            check_in="2023-10-01", check_out="2023-10-05", as_of_date="2023-09-30", city="City A"
        )
        RoomPrice.objects.create(
            hotel="Hotel B", room_price=150.0, review_score=4.0, price_per_review=37.5,
            check_in="2023-10-01", check_out="2023-10-05", as_of_date="2023-09-30", city="City B"
        )
